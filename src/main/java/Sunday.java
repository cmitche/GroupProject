...
public class Sunday {
    public static void main(String[] args) {
        ...
        CropRow cropRowSunday1 = new CropRow(new TomatoPlant(new Tomato()), 12);
        System.out.println(froilan.plantCrops(cropRowSunday1.getCrop()));
        CropRow cropRowSunday2 = new CropRow(new CornStalk(new EarCorn(3)), 12);
        System.out.println(froilan.plantCrops(cropRowSunday2.getCrop()));
        CropRow cropRowSunday3 = new CropRow(new TomatoPlant(new Tomato()), 12);
        System.out.println(froilan.plantCrops(cropRowSunday3.getCrop()));
